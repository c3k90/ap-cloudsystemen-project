...
export default function SimonSaysGame({ onBack, themeColor }: SimonSaysGameProps) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center p-4">
        <div className="bg-card rounded-2xl shadow-2xl p-8 max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-card-foreground mb-2">Choose Difficulty</h2>
                  ...
                  className={`
                    ...
                    ${
                      difficulty === diff
                        ...
                        : "border-border hover:border-purple-300 hover:bg-secondary"
                    }
                  `}
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 text-left">
                      <div className="font-semibold text-card-foreground">{config.name}</div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center p-4">
        <div className="bg-card rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
          <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-card-foreground mb-2">Simon Says</h1>
            <p className="text-muted-foreground">Watch the sequence and repeat it back!</p>
          </div>
      ...
      <div className={`min-h-screen bg-gradient-to-br ${config.color} flex items-center justify-center p-4`}>
        <div className="bg-card rounded-2xl shadow-2xl p-8 max-w-md w-full text-center">
          <div className="mb-6">
            ...
            <h2 className="text-3xl font-bold text-card-foreground mb-2">Game Over!</h2>
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${config.color} flex items-center justify-center p-4`}>
      <div className="bg-card rounded-2xl shadow-2xl p-8 max-w-lg w-full">
        {/* Header */}
        <div className="text-center mb-8">
          <div className="flex justify-between items-center mb-4">
            <div className="text-sm text-muted-foreground">Round ({config.name})</div>
            <div className="text-2xl font-bold text-purple-600">{score + 1}</div>
          </div>

          {gameState === "showing" && (
            <div className="text-lg font-semibold text-card-foreground animate-pulse">
