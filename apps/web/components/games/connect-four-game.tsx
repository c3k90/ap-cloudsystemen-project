      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground">{gameMode === "pvp" ? "Player vs Player" : "Player vs CPU"}</p>
          </div>
        ...
        {/* Game Board */}
        <div className="bg-card rounded-2xl p-6 shadow-lg border-4 border-black">
