...
export default function BreakoutGame({ onBack, themeColor }: BreakoutGameProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-card p-8">
      <div className="relative">
        <canvas
          ref={canvasRef}
          className="border border-border rounded-lg shadow-sm cursor-none"
          style={{ maxWidth: "100%", height: "auto" }}
          onMouseMove={handleMouseMove}
        />
        {gameState === "menu" && (
          <div className="absolute inset-0 flex items-center justify-center bg-card/95 backdrop-blur-sm rounded-lg">
            <Card className="p-8 text-center border-border shadow-sm w-96">
              <div className="mb-6">
                <div
                ...
                <h1 className="text-2xl font-medium text-card-foreground mb-2">Breakout</h1>
                <p className="text-sm text-muted-foreground mb-4">Break all the bricks with your ball</p>
                <div className="bg-secondary rounded-lg p-3 text-left text-xs text-muted-foreground space-y-1">
                  <div className="font-medium text-card-foreground">Controls:</div>
                  <div>
                    <kbd className="px-2 py-1 bg-card rounded border text-xs">←→</kbd> or{" "}
                    <kbd className="px-2 py-1 bg-card rounded border text-xs">A D</kbd> or{" "}
                    <kbd className="px-2 py-1 bg-card rounded border text-xs">Mouse</kbd> to Move
                  </div>
                  <div>
                    <kbd className="px-2 py-1 bg-card rounded border text-xs">P</kbd> or{" "}
                    <kbd className="px-2 py-1 bg-card rounded border text-xs">Space</kbd> to Pause
                  </div>
                </div>
              </div>
              <Button
        ...
        {(gameState === "gameOver" || gameState === "won") && (
          <div className="absolute inset-0 flex items-center justify-center bg-card/95 backdrop-blur-sm rounded-lg">
            <Card className="p-8 text-center border-border shadow-sm w-96">
              <h2 className="text-lg font-medium text-muted-foreground mb-1">Breakout</h2>
              ...
              <div className="flex gap-3 justify-center">
                ...
                <Button
                  ...
                  variant="outline"
                  className="border-border text-card-foreground hover:bg-secondary px-4 py-2 text-sm font-medium"
                >
                  Menu
                </Button>
              </div>
              <div className="mt-4 text-xs text-muted-foreground space-x-4">
                <span>
                  <kbd className="px-1 py-0.5 bg-secondary rounded text-xs">Enter</kbd> Again
                </span>
                <span>
                  <kbd className="px-1 py-0.5 bg-secondary rounded text-xs">Esc</kbd> Menu
                </span>
              </div>
            </Card>
          </div>
