  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-card p-8">
      <div className="relative">
        <canvas
          ref={canvasRef}
          className="border border-border rounded-lg shadow-sm cursor-pointer"
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-card/95 backdrop-blur-sm rounded-lg">
            <Card className="p-8 text-center border-border shadow-sm w-96">
              <div className="mb-6">
                ...
                <h1 className="text-2xl font-medium text-card-foreground mb-2">Tic Tac Toe</h1>
                <p className="text-sm text-muted-foreground mb-4">Classic strategy game - get three in a row!</p>
                <div className="bg-secondary rounded-lg p-3 text-left text-xs text-muted-foreground space-y-1">
                  <div className="font-medium text-card-foreground">How to Play:</div>
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full border-border text-card-foreground hover:bg-secondary px-6 py-2 text-sm font-medium"
                >
                  Play vs Human
                </Button>
              </div>
        ...
        {gameState === "gameOver" && (
          <div className="absolute inset-0 flex items-center justify-center bg-card/95 backdrop-blur-sm rounded-lg">
            <Card className="p-8 text-center border-border shadow-sm w-96">
              <h2 className="text-lg font-medium text-muted-foreground mb-1">Tic Tac Toe</h2>
              ...
              <div className="space-y-3 mb-6">
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-mono text-card-foreground">{scores.ties}</div>
                  </div>
                  <div>
                    <div className="text-muted-foreground">O Wins</div>
                    <div className="text-xl font-mono text-card-foreground">{scores.O}</div>
                  </div>
                </div>
              </div>
