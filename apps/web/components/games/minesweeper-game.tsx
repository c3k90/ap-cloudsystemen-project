        ...
        {!showStartModal && (
          <>
            <div className="flex items-center justify-between mb-4">
              ...
              <h1 className="text-xl font-bold text-card-foreground">Minesweeper</h1>
        ...
        {showStartModal && (
          <div className="fixed inset-0 bg-foreground/50 flex items-center justify-center z-50">
            <Card className="p-8 text-center w-full max-w-sm">
              ...
              <p className="text-muted-foreground mb-6">Select a difficulty to start.</p>
              ...
              <div className="text-left text-sm text-muted-foreground bg-secondary p-3 rounded-md">
