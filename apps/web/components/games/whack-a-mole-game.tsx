...
export default function WhackAMoleGame({ onBack, themeColor }: WhackAMoleGameProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-400 via-green-500 to-green-600 flex items-center justify-center p-4">
      <div className="bg-card rounded-2xl shadow-2xl p-8 max-w-2xl w-full">
        {/* Header */}
        <div className="flex items-center justify-between mb-6">
          ...
          <h1 className="text-2xl font-bold text-card-foreground">Whack-a-Mole</h1>
          <div className="w-20" />
        </div>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-xl font-bold text-card-foreground">{bestScores[key]}</div>
                    </div>
                  </div>
                </div>
              ))}
        ...
        {gameState === "playing" && (
          <>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
              ...
              <div className="bg-secondary rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-card-foreground">{timeLeft}</div>
                <div className="text-sm text-muted-foreground">Time</div>
              </div>
              <div className="bg-secondary rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-card-foreground">{level}</div>
                <div className="text-sm text-muted-foreground">Level</div>
              </div>
              <div className="bg-secondary rounded-lg p-3 text-center">
                <div className="text-2xl font-bold text-card-foreground">{accuracy}%</div>
