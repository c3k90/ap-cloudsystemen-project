        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            <div className="mb-6">
              ...
              <h1 className="text-3xl font-bold text-card-foreground mb-2">Bubble Pop</h1>
              <p className="text-muted-foreground">Pop colorful bubbles and build combos!</p>
            </div>
  ...
  if (gameState === "gameOver") {
    return (
      ...
      >
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            <h1 className="text-3xl font-bold text-card-foreground mb-4">Game Over!</h1>
    ...
    >
      ...
      <div className="absolute top-4 left-4 right-4 z-10 flex justify-between items-start">
        ...
        <div className="bg-card/90 backdrop-blur-sm rounded-lg p-3 min-w-[80px] text-center">
          ...
          <div className="text-xl font-bold text-card-foreground">{Math.ceil(timeLeft)}</div>
        </div>
