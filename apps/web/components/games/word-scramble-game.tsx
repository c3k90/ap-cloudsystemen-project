          ...
          <div className="text-center">
            <Card className="p-8 shadow-xl border-purple-200">
              <div className="mb-6">
                ...
                <h1 className="text-3xl font-bold text-card-foreground mb-2">Word Scramble</h1>
                <p className="text-muted-foreground mb-6">Unscramble the letters to form words!</p>
                ...
                <div className="bg-purple-50 rounded-lg p-4 text-left text-sm text-muted-foreground">
        ...
        {gameState === "playing" && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              ...
              <Card className="p-3 text-center">
                <div className="text-sm font-bold text-card-foreground capitalize">{category}</div>
            ...
            <Card className="p-8 text-center shadow-xl">
              <div className="mb-6">
                <h2 className="text-lg font-semibold text-card-foreground mb-4">Unscramble this word:</h2>
        ...
        {gameState === "gameOver" && (
          <div className="text-center">
            <Card className="p-8 shadow-xl border-border">
              <h2 className="text-2xl font-bold text-card-foreground mb-4">Time's Up!</h2>
